...
if __name__ == '__main__':
    if method == 'Seq2Seq':
        ...
        headline_train_lengths = np.load('./data/headline_train_lengths.npy')
        headline_train_pad = np.load('./data/headline_train_pad.npy')
        text_train_lengths = np.load('./data/text_train_lengths.npy')
        text_train_pad = np.load('./data/text_train_pad.npy')
